...
var Comp = /** @class */ (function (_super) {
    ...
    Comp.prototype.componentDidMount = function () {
        if (!this.props.status)
            this.props.dispatch(async_thunks_1.retrieveData()); // only get data when it's not available
    };
...
exports.HelloWorld = react_redux_1.connect(function (state) { return __assign({}, state); })(Comp);
