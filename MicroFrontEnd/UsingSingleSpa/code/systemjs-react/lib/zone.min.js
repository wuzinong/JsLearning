...
!(function (e) {
  ...
  function v(e, t) {
    for (var n = e.length - 1; n >= 0; n--)
      "function" == typeof e[n] && (e[n] = s(e[n], t + "_" + n));
    return e;
  }
  function g(e) {
    return (
        ...
        return (
          ...
          (e.prototype.then = function (n, r) {
            ...
            var a = new o(S),
              i = t.current;
            return (
              null == this[d] ? this[v].push(i, a, n, r) : w(this, i, a, n, r),
              a
            );
          }),
          ...
          (e.prototype.finally = function (n) {
            ...
            var a = t.current;
            return (
              null == this[d] ? this[v].push(a, o, n, n) : w(this, a, o, n, n),
              o
            );
          }),
          e
              ...
              if (!v || v(t, u, s, arguments)) {
                ...
                if (z)
                  for (var y = 0; y < z.length; y++)
                    if (l === z[y])
                      return h ? t.call(s, l, u, d) : t.apply(this, arguments);
                ...
                if (Z) {
                  if (((D = !0), g))
                    for (y = 0; y < Z.length; y++) if (j(Z[y], u)) return;
                } else Z = s[O] = [];
   ...
   */ function le() {
    (q = Zone.__symbol__),
      ...
      (V = Object[q("getOwnPropertyDescriptor")] =
  ...
  function pe(e, t, n) {
    return (
      ...
      n.configurable ||
        (e[Y] || Object.isFrozen(e) || U(e, Y, { writable: !0, value: {} }),
        e[Y] && (e[Y][t] = !0)),
      n
    );
  }
        ...
        vh: function (e, t, n, r) {
          if (!h && v) {
            if (d)
              try {
                var o;
                if ("[object FunctionWrapper]" === (o = t.toString()) || o == g)
              ...
              self.addEventListener(
                ...
                function (t) {
                  var r,
                    ...
                    i = t.target;
                  for (
                    o = i ? i.constructor.name + "." + a : "unknown." + a;
                    i;

                  )
                    i[a] &&
                      !i[a][n] &&
                      (((r = e.wrapWithCurrentZone(i[a], o))[n] = i[a]),
                      (i[a] = r)),
                      (i = i.parentElement);
                },
                !0
          ...
          "number" == typeof a ? (o = i[a]) : (o = a && a[ge]) || (o = a),
            o && "string" == typeof o.type
              ? "notScheduled" !== o.state &&
                ...
                ("number" == typeof a ? delete i[a] : a && (a[ge] = null),
                o.zone.cancelTask(o))
              : t.apply(e, r);
        };
      }));
  ...
  Zone.__load_patch("legacy", function (e) {
    ...
    Zone.__load_patch("timers", function (e) {
      ye(e, "set", "clear", "Timeout"),
        ye(e, "set", "clear", "Interval"),
        ye(e, "set", "clear", "Immediate");
    }),
