...
(t = this),
  (e = function () {
    ...
    function U(t) {
      ...
      return function (r, n) {
        for (
          var o = "",
            i = r || {},
            a = (n || {}).pretty ? q : encodeURIComponent,
            u = 0;
          u < t.length;
          u++
        ) {
    ...
    function N(t, e) {
        ...
        if (s) {
          ...
          if (
            ...
            for (var h in r.params)
              !(h in u.params) &&
                f.indexOf(h) > -1 &&
                (u.params[h] = r.params[h]);
          return (u.path = D(p.path, u.params)), c(p, u, a);
        }
        if (u.path) {
          u.params = {};
      ...
      function u(t, r) {
        ...
        if (p) {
          ...
          return a(
            { _normalized: !0, path: D(v, d), query: h, hash: l },
            void 0,
            r
          );
        }
    ...
    function Y() {
      ...
      window.history.replaceState({ key: ct() }, "", e),
    ...
    (mt.prototype.listen = function (t) {
      ...
      (mt.prototype.confirmTransition = function (e, r, n) {
        ...
        if (y(e, i) && e.matched.length === i.matched.length)
