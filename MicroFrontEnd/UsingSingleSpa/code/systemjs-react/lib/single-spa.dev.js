    ...
    execute: function () {
      ...
      function formatErrorMessage(code, msg) {
        ...
        return "single-spa minified message #"
          ...
          .concat(code)
          .concat(args.length ? "&arg=".concat(args.join("&arg=")) : "");
      }
      function transformErr(ogErr, appOrParcel, newStatus) {
        var errPrefix = ""
          .concat(objectType(appOrParcel), " '")
          .concat(toName(appOrParcel), "' died in status ")
      ...
      var LOADING_SOURCE_CODE = exports(
        "LOADING_SOURCE_CODE",
        "LOADING_SOURCE_CODE"
      );
      ...
      var SKIP_BECAUSE_BROKEN = exports(
        "SKIP_BECAUSE_BROKEN",
        "SKIP_BECAUSE_BROKEN"
      );
              ...
              return smellsLikeAPromise(thisPromise)
                ...
                : Promise.reject(
                    formatErrorMessage(
                      ...
                      "Within "
                        .concat(type, " ")
                        .concat(name, ", the lifecycle function ")
                        .concat(lifecycle, " at array index ")
                        .concat(index, " did not return a promise"),
                      type,
                      name,
                      lifecycle,
                      index
      ...
      function toUnmountPromise(appOrParcel, hardFail) {
        return Promise.resolve().then(function () {
          ...
          var unmountChildrenParcels = Object.keys(appOrParcel.parcels).map(
            function (parcelId) {
              return appOrParcel.parcels[parcelId].unmountThisParcel();
            }
          );
          return Promise.all(unmountChildrenParcels)
            .then(unmountAppOrParcel, function (parcelError) {
        ...
        return Promise.resolve().then(function () {
          ...
          if (!beforeFirstMountFired) {
            window.dispatchEvent(
              new customEvent("single-spa:before-first-mount")
            );
      ...
      function mountParcel(config, customProps) {
        ...
        if (
          !config ||
          (_typeof(config) !== "object" && typeof config !== "function")
        ) {
          throw Error(
            formatErrorMessage(
              2,
        ...
        if (config.name && typeof config.name !== "string") {
          throw Error(
            formatErrorMessage(
              3,
              "Parcel name must be a string, if provided. Was given ".concat(
                _typeof(config.name)
              ),
              _typeof(config.name)
            )
          ...
          throw Error(
            formatErrorMessage(
              ...
              "Parcel "
                .concat(
                  name,
                  " has invalid customProps -- must be an object but was given "
                )
                .concat(_typeof(customProps)),
              name,
              _typeof(customProps)
            )
          );
        ...
        if (!customProps.domElement) {
          throw Error(
            formatErrorMessage(
              ...
              "Parcel ".concat(
                name,
                " cannot be mounted without a domElement provided as a prop"
              ),
              name
            )
          );
        ...
        var configLoadingFunction = passedConfigLoadingFunction
          ? config
          : function () {
        ...
        loadPromise = loadPromise.then(function (config) {
          ...
          if (
            ...
            throw Error(
              formatErrorMessage(
                ...
                "Parcel ".concat(
                  name,
                  " provided an invalid bootstrap function"
                ),
                name
              )
            );
          ...
          if (!validLifecycleFn(config.mount)) {
            throw Error(
              formatErrorMessage(
                10,
                "Parcel ".concat(name, " must have a valid mount function"),
                name
              )
            );
          }
          ...
          if (!validLifecycleFn(config.unmount)) {
            throw Error(
              formatErrorMessage(
                11,
                "Parcel ".concat(name, " must have a valid unmount function"),
                name
              )
            );
          }
          ...
          if (config.update && !validLifecycleFn(config.update)) {
            throw Error(
              formatErrorMessage(
                12,
                "Parcel ".concat(name, " provided an invalid update function"),
                name
              )
            );
          }
          ...
          console.warn(
            formatErrorMessage(
              ...
              "single-spa: "
                .concat(
                  name,
                  "'s customProps function must return an object. Received "
                )
                .concat(customProps)
            ),
            name,
      ...
      function reasonableTime(appOrParcel, lifecycle) {
        ...
        return new Promise(function (resolve, reject) {
          ...
          var errMsg = formatErrorMessage(
            31,
            "Lifecycle function "
              .concat(lifecycle, " for ")
              .concat(type, " ")
              .concat(
                toName(appOrParcel),
                " lifecycle did not resolve or reject for "
              )
              .concat(timeoutConfig.millis, " ms."),
            lifecycle,
            type,
            toName(appOrParcel),
            timeoutConfig.millis
            ...
            .then(function () {
              ...
              return loadPromise.then(function (val) {
                ...
                if (
...

                  {
                    validationErrMessage =
                      "does not export a valid bootstrap function or array of functions";
                  }
                }
                ...
                if (!validLifecycleFn(appOpts.mount)) {
                  ...
                  {
                    validationErrMessage =
                      "does not export a mount function or array of functions";
                  }
                }
                ...
                if (!validLifecycleFn(appOpts.unmount)) {
                  ...
                  {
                    validationErrMessage =
                      "does not export a unmount function or array of functions";
                  }
                }
                ...
                if (validationErrCode) {
                  ...
                  console.error(
                    formatErrorMessage(
                      validationErrCode,
                      "The loading function for single-spa "
                        .concat(type, " '")
                        .concat(
                          toName(app),
      ...
      function registerApplication(
        ...
        if (getAppNames().indexOf(registration.name) !== -1)
          throw Error(
            formatErrorMessage(
              21,
              "There is already an app registered with name ".concat(
                registration.name
              ),
              registration.name
            )
        ...
        if (opts && opts.waitForUnmount) {
          ...
          if (appUnloadInfo) {
            ...
            immediatelyUnloadApp(
              app,
              appUnloadInfo.resolve,
              appUnloadInfo.reject
            );
          } else {
            // We're the first ones wanting the app to be resolved.
      ...
      function validateRegisterWithConfig(config) {
        if (Array.isArray(config) || config === null)
          throw Error(
            formatErrorMessage(
              39,
              "Configuration object can't be an Array or null!"
            )
          );
        var validKeys = ["name", "app", "activeWhen", "customProps"];
        var invalidKeys = Object.keys(config).reduce(function (
          invalidKeys,
          prop
        ) {
          return validKeys.indexOf(prop) >= 0
            ? invalidKeys
            : invalidKeys.concat(prop);
        },
        []);
        if (invalidKeys.length !== 0)
          throw Error(
            formatErrorMessage(
              38,
              "The configuration object accepts only: "
                .concat(validKeys.join(", "), ". Invalid keys: ")
                .concat(invalidKeys.join(", "), "."),
              validKeys.join(", "),
              invalidKeys.join(", ")
            )
          );
        ...
        var allowsStringAndFunction = function allowsStringAndFunction(
          activeWhen
        ) {
          return (
      ...
      function sanitizeArguments(
        ...
        registration.customProps = sanitizeCustomProps(
          registration.customProps
        );
      ...
      function sanitizeActiveWhen(activeWhen) {
        var activeWhenArray = Array.isArray(activeWhen)
          ? activeWhen
          : [activeWhen];
        activeWhenArray = activeWhenArray.map(function (activeWhenOrPath) {
          return typeof activeWhenOrPath === "function"
            ? activeWhenOrPath
      ...
      function toDynamicPathValidatorRegex(path, exactMatch) {
        ...
        function appendToRegex(index) {
          ...
          var commonStringSubPath = escapeStrRegex(
      ...
      function reroute() {
        ...
        function loadApps() {
          return Promise.resolve().then(function () {
            ...
            return Promise.all(loadPromises)
              .then(callAllEventListeners) // there are no mounted apps, before start() is called, so we always return []
              .then(function () {
                return [];
              })
              .catch(function (err) {
        ...
        function getCustomEventDetail() {
          ...
          var appsByNewStatus =
            ((_appsByNewStatus = {}),
            _defineProperty(_appsByNewStatus, MOUNTED, []),
            _defineProperty(_appsByNewStatus, NOT_MOUNTED, []),
            _defineProperty(_appsByNewStatus, NOT_LOADED, []),
            _defineProperty(_appsByNewStatus, SKIP_BECAUSE_BROKEN, []),
            _appsByNewStatus);
          ...
          var result = {
            detail: {
              ...
              originalEvent:
                eventArguments === null || eventArguments === void 0
                  ? void 0
                  : eventArguments[0],
              oldUrl: oldUrl,
              newUrl: newUrl,
          ...
          function addApp(app, status) {
            ...
            var statusArr = (appsByNewStatus[status] =
