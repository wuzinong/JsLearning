...
*/
  ...
  (function (N, kb) {
    "object" === typeof exports && "undefined" !== typeof module
      ...
      ? define(["exports", "react"], kb)
      : ((N = N || self), kb((N.ReactDOM = {}), N.React));
  })(this, function (N, kb) {
    function n(a) {
      for (
    ...
    function be(a) {
      ...
      if ("object" === typeof a)
        switch (a.$$typeof) {
          ...
          case he:
            return (
              (b = a.displayName || null), null !== b ? b : be(a.type) || "Memo"
            );
          case Ra:
            b = a._payload;
            a = a._init;
    ...
    function je(a, b) {
      ...
      b.hasOwnProperty("value")
        ? ke(a, b.type, c)
        : b.hasOwnProperty("defaultValue") && ke(a, b.type, Sa(b.defaultValue));
      null == b.checked &&
    ...
    function ke(a, b, c) {
      if ("number" !== b || Nc(a.ownerDocument) !== a)
        null == c
    ...
    function uj(a, b, c, d, e) {
      switch (b) {
        ...
        case "gotpointercapture":
          return (
            (f = e.pointerId),
            gc.set(f, hc(gc.get(f) || null, a, b, c, d, e)),
            !0
          );
      }
      return !1;
    ...
    function ic(a, b) {
      a.blockedOn === b &&
        ((a.blockedOn = null), ye || ((ye = !0), Fg(Gg, xj)));
    }
    function jc(a) {
      if (0 < Vc.length) {
        ic(Vc[0], a);
      ...
      fc.forEach(b);
      gc.forEach(b);
      for (b = 0; b < Wa.length; b++)
        (c = Wa[b]), c.blockedOn === a && (c.blockedOn = null);
      for (; 0 < Wa.length && ((b = Wa[0]), null === b.blockedOn); )
        Dg(b), null === b.blockedOn && Wa.shift();
    }
    function yj(a, b, c, d) {
      var e = x,
        f = Db.transition;
    ...
    function Kg() {
      ...
      var a,
        ...
        c = b.length,
        d,
        e = "value" in Xa ? Xa.value : Xa.textContent,
        f = e.length;
    ...
    function Ij(a, b) {
      if (Eb)
        return "compositionend" === a || (!Ee && Mg(a, b))
          ? ((a = Kg()), (Zc = Ce = Xa = null), (Eb = !1), a)
          : null;
      switch (a) {
        case "paste":
          return null;
    ...
    function Sg(a, b, c, d) {
      ...
      b = bd(b, "onChange");
      0 < b.length &&
        ((c = new Fe("onChange", "change", null, c, d)),
    ...
    function Nj(a, b, c) {
      "focusin" === a
        ? (Ug(), (kc = b), (lc = c), kc.attachEvent("onpropertychange", Vg))
        : "focusout" === a && Ug();
    }
    function Oj(a, b) {
    ...
    function Sj(a) {
      ...
      if (
        ...
        c &&
        c.ownerDocument &&
        Yg(c.ownerDocument.documentElement, c)
      ) {
        if (null !== d && Ge(c))
          if (
            ((b = d.start),
    ...
    function $g(a, b, c) {
      ...
      He ||
        ...
        (nc && mc(nc, d)) ||
          ...
          (d = bd(Ie, "onSelect")),
          0 < d.length &&
            ((b = new Fe("onSelect", "select", null, b, c)),
    ...
    function Ae(a, b, c, d, e) {
      ...
      sg(function () {
          ...
          if (void 0 !== h) {
            ...
            for (var w = d, r; null !== w; ) {
              ...
              5 === r.tag &&
                ...
                ((r = W),
                null !== A &&
                  ((W = bc(w, A)), null != W && m.push(pc(w, W, r))));
              if (p) break;
              w = w.return;
            }
            0 < m.length &&
        ...
        if (0 === (b & 7)) {
          ...
          switch (a) {
            case "focusin":
              if (Rg(va) || "true" === va.contentEditable)
                (Gb = va), (Ie = d), (nc = null);
              break;
            case "focusout":
              nc = Ie = Gb = null;
          ...
          ca &&
            (Qg &&
              "ko" !== c.locale &&
              (Eb || "onCompositionStart" !== ca
                ? "onCompositionEnd" === ca && Eb && (Za = Kg())
                : ((Xa = e),
                  (Ce = "value" in Xa ? Xa.value : Xa.textContent),
                  (Eb = !0))),
            (va = bd(d, ca)),
            0 < va.length &&
              ((ca = new mh(ca, a, null, c, e)),
              g.push({ event: ca, listeners: va }),
              Za
                ? (ca.data = Za)
                : ((Za = Ng(c)), null !== Za && (ca.data = Za))));
          if ((Za = dk ? Hj(a, c) : Ij(a, c)))
            (d = bd(d, "onBeforeInput")),
              0 < d.length &&
                ((e = new ek("onBeforeInput", "beforeinput", null, c, e)),
    ...
    function bd(a, b) {
      for (var c = b + "Capture", d = []; null !== a; ) {
        ...
        5 === e.tag &&
          ...
          ((e = f),
          (f = bc(a, c)),
          null != f && d.unshift(pc(a, f, e)),
          (f = bc(a, b)),
          null != f && d.push(pc(a, f, e)));
        a = a.return;
      }
      return d;
    }
    ...
    function kh(a, b, c, d, e) {
      for (var f = b._reactName, g = []; null !== c && c !== d; ) {
        ...
        5 === h.tag &&
          ...
          ((h = l),
          e
            ? ((k = bc(c, f)), null != k && g.unshift(pc(c, k, h)))
            : e || ((k = bc(c, f)), null != k && g.push(pc(c, k, h))));
        c = c.return;
      }
    ...
    function qh(a, b, c) {
      ...
      d = d.getChildContext();
      for (var e in d)
        if (!(e in b)) throw Error(n(108, fj(a) || "Unknown", e));
      return D({}, c, d);
    }
    function id(a) {
      a =
    ...
    function Mb(a, b) {
      ...
      null !== a &&
        null !== a.firstContext &&
        (0 !== (a.lanes & b) && (ea = !0), (a.firstContext = null));
    }
    function la(a) {
      var b = a._currentValue;
      if (Ue !== a)
        if (((a = { context: a, memoizedValue: b, next: null }), null === Lb)) {
          if (null === kd) throw Error(n(308));
          Lb = a;
          kd.dependencies = { lanes: 0, firstContext: a };
        } else Lb = Lb.next = a;
      return b;
    }
    function Xe(a) {
    ...
    function cb(a, b, c) {
      ...
      null !== c &&
        ((c = c.shared),
        (null === G && null === ma) || 0 === (a.mode & 1) || 0 !== (p & 2)
          ? ((a = c.pending),
            null === a ? (b.next = b) : ((b.next = a.next), (a.next = b)),
            (c.pending = b))
          : ((a = c.interleaved),
            null === a
              ? ((b.next = b), null === ma ? (ma = [c]) : ma.push(c))
    ...
    function Ze(a, b, c, d) {
      ...
      "object" === typeof f && null !== f
        ? (e.context = la(f))
        : ((f = da(b) ? ob : I.current), (e.context = Kb(a, f)));
      e.state = a.memoizedState;
      ...
      "function" === typeof b.getDerivedStateFromProps ||
        ...
        b !== e.state && od.enqueueReplaceState(e, e.state, null),
        nd(a, c, e, d),
        (e.state = a.memoizedState));
    ...
    function af(a) {
      for (; a === qd; )
        (qd = Nb[--Ob]), (Nb[Ob] = null), (pd = Nb[--Ob]), (Nb[Ob] = null);
      for (; a === qb; )
        (qb = oa[--pa]),
          (oa[pa] = null),
          (Na = oa[--pa]),
        ...
        case 5:
          ...
          b =
            1 !== b.nodeType || c.toLowerCase() !== b.nodeName.toLowerCase()
              ...
              : b;
          return null !== b
            ? ((a.stateNode = b), (ka = a), (fa = Ja(b.firstChild)), !0)
            : !1;
        case 6:
          return (
            (b = "" === a.pendingProps || 3 !== b.nodeType ? null : b),
            null !== b ? ((a.stateNode = b), (ka = a), (fa = null), !0) : !1
          );
        case 13:
          return (
            (b = 8 !== b.nodeType ? null : b),
            null !== b
              ? ((c = null !== qb ? { id: Ma, overflow: Na } : null),
                (a.memoizedState = {
                  dehydrated: b,
                  treeContext: c,
      ...
      if (C) {
        ...
        if (b) {
          ...
          if (!Dh(a, b)) {
            ...
            b && Dh(a, b)
              ? Ch(d, c)
              : ((a.flags = (a.flags & -4097) | 2), (C = !1), (ka = a));
          }
        } else {
          if (bf(a)) throw Error(n(418));
    ...
    function rc(a) {
      ...
      (b = 3 !== a.tag) &&
        !(b = 5 !== a.tag) &&
        ((b = a.type),
        (b = "head" !== b && "body" !== b && !Pe(a.type, a.memoizedProps)));
      if (b && (b = fa)) {
        if (bf(a)) {
    ...
    function Gh(a) {
      ...
      function k(a, b, c, d) {
        ...
        if (
          ...
          return (d = e(b, c.props)), (d.ref = sc(a, b, c)), (d.return = a), d;
      ...
      function l(a, b, c, d) {
        if (
          ...
          return (b = ff(c, a.mode, d)), (b.return = a), b;
        b = e(b, c.children || []);
        b.return = a;
        return b;
      }
      function m(a, b, c, d, f) {
        if (null === b || 7 !== b.tag)
          return (b = rb(c, a.mode, d, f)), (b.return = a), b;
        b = e(b, c);
        b.return = a;
        return b;
      }
      function Ne(a, b, c) {
        ...
        if ("object" === typeof b && null !== b) {
          switch (b.$$typeof) {
            case td:
              return (
                (c = sd(b.type, b.key, b.props, null, a.mode, c)),
                (c.ref = sc(a, null, b)),
                (c.return = a),
                c
              );
          ...
          if (Zb(b) || Xb(b))
            return (b = rb(b, a.mode, c, null)), (b.return = a), b;
          rd(a, b);
        }
        return null;
      }
      ...
      function v(e, g, h, k) {
        for (
          var l = null, n = null, m = g, r = (g = 0), w = null;
          null !== m && r < h.length;
          r++
        ) {
      ...
      function u(e, g, h, k) {
        ...
        for (
          var m = (l = null), r = g, w = (g = 0), A = null, t = h.next();
          null !== r && !t.done;
          w++, t = h.next()
        ) {
        ...
        for (r = d(e, r); !t.done; w++, t = h.next())
          (t = p(r, e, w, t.value, k)),
            null !== t &&
              (a &&
                null !== t.alternate &&
                r.delete(null === t.key ? w : t.key),
              (g = f(t, g, w)),
              null === m ? (l = t) : (m.sibling = t),
              (m = t));
        a &&
          ...
          switch (f.$$typeof) {
            case td:
              a: {
                ...
                f.type === yb
                  ? ((d = rb(f.props.children, a.mode, h, f.key)),
                    (d.return = a),
                    (a = d))
                  : ((h = sd(f.type, f.key, f.props, null, a.mode, h)),
                    (h.ref = sc(a, d, f)),
                    (h.return = a),
                    (a = h));
              }
        ...
        return ("string" === typeof f && "" !== f) || "number" === typeof f
          ? ((f = "" + f),
            null !== d && 6 === d.tag
              ...
              : (c(a, d), (d = ef(f, a.mode, h)), (d.return = a), (a = d)),
            g(a))
          : c(a, d);
      }
      return x;
    ...
    function Xh(a, b, c) {
      if (0 === (tb & 21))
        return (
          a.baseState && ((a.baseState = !1), (ea = !0)), (a.memoizedState = c)
        );
    ...
    function ai(a, b, c, d) {
      (null === G && null === ma) || 0 === (a.mode & 1) || 0 !== (p & 2)
        ...
        : ((a = b.interleaved),
          null === a
            ? ((c.next = c), null === ma ? (ma = [b]) : ma.push(b))
    ...
    function di(a, b, c) {
      ...
      null !== f &&
        ...
        (c.callback = function () {
          uf(a, b);
          "function" !== typeof d &&
            (null === gb ? (gb = new Set([this])) : gb.add(this));
          var c = b.stack;
      ...
      switch (b.tag) {
          ...
          if (null === a || null === a.child)
            rc(b)
              ...
              : null === a ||
                ...
                ((b.flags |= 1024), null !== xa && (wf(xa), (xa = null)));
          hi(a, b);
          T(b);
          return null;
        case 5:
                ...
                for (f in h)
                  if (h.hasOwnProperty(f)) {
                    ...
                    "style" === f
                      ...
                      ? ((k = k ? k.__html : void 0), null != k && ii(a, k))
                      : "children" === f
                      ? "string" === typeof k
                        ? ("textarea" !== c || "" !== k) && Cc(a, k)
                        : "number" === typeof k && Cc(a, "" + k)
                ...
                switch (c) {
                  ...
                  case "select":
                    ...
                    null != f
                      ? Ab(a, !!d.multiple, f, !1)
                      : null != d.defaultValue &&
                        Ab(a, !!d.multiple, d.defaultValue, !0);
                    break;
                  default:
        ...
        case 4:
          return (
            Qb(),
            hi(a, b),
            null === a && oc(b.stateNode.containerInfo),
            T(b),
            null
          );
        case 10:
        ...
        case 19:
          ...
          if (null === g)
            if (d) Ac(f, !1);
              ...
              null !== f.tail &&
                M() > yf &&
                ((b.flags |= 128), (d = !0), Ac(f, !1), (b.lanes = 4194304));
            }
          else {
            if (!d)
              if (((a = ud(g)), null !== a)) {
    ...
    function li(a, b, c, d, e) {
      if (null === a) {
        ...
        if (
          ...
          return (b.tag = 15), (b.type = f), mi(a, b, f, d, e);
    ...
    function mi(a, b, c, d, e) {
      if (null !== a) {
        ...
        if (mc(f, d) && a.ref === b.ref)
          if (((ea = !1), (b.pendingProps = d = f), 0 !== (a.lanes & e)))
            0 !== (a.flags & 131072) && (ea = !0);
    ...
    function pi(a, b, c, d, e) {
      ...
      if (null === b.stateNode)
        ...
        nd(b, d, g, e);
        k = b.memoizedState;
        h !== d || q !== k || P.current || db
          ? ("function" === typeof m && (Ye(b, c, m, d), (k = b.memoizedState)),
            (h = db || xh(b, c, h, d, q, k, l))
              ? (n ||
        ...
        h !== n || q !== v || P.current || db
          ? ("function" === typeof p && (Ye(b, c, p, d), (v = b.memoizedState)),
            (l = db || xh(b, c, l, d, q, v, k) || !1)
              ? (m ||
    ...
    function Bf(a, b, c, d, e, f) {
      ...
      b.flags |= 1;
      null !== a && g
        ? ((b.child = Rb(b, a.child, null, f)), (b.child = Rb(b, null, h, f)))
        : aa(a, b, h, f);
    ...
    function qi(a) {
      var b = a.stateNode;
      b.pendingContext
        ? ph(a, b.pendingContext, b.pendingContext !== b.context)
        : b.context && ph(a, b.context, !1);
    ...
    function ti(a, b, c) {
      ...
      if (null !== e) {
        ...
        if (null !== h) {
          if (g) {
            if (b.flags & 256)
              return (b.flags &= -257), Ed(a, b, c, Error(n(422)));
            if (null !== b.memoizedState)
              return (b.child = a.child), (b.flags |= 128), null;
            f = d.fallback;
            e = b.mode;
            d = Cd({ mode: "visible", children: d.children }, e, 0, null);
            f = rb(f, e, c, null);
            f.flags |= 2;
            d.return = b;
            f.return = b;
            ...
            "$?" === h.data
              ...
              : ((c = e.treeContext),
                ...
                null !== c &&
                  ...
                  (Na = c.overflow),
                  (qb = b)),
                (b = Cf(b, b.pendingProps.children)),
                (b.flags |= 4096));
          return b;
        }
        if (f)
          return (
            (d = ui(a, b, d.children, d.fallback, c)),
            (f = b.child),
            (e = a.child.memoizedState),
            (f.memoizedState = null === e ? Bd(c) : si(e, c)),
    ...
    function Cf(a, b, c) {
      b = Cd({ mode: "visible", children: b }, a.mode, 0, null);
      b.return = a;
      return (a.child = b);
    }
    function vi(a, b, c, d) {
      var e = a.child;
      a = e.sibling;
      c = eb(e, { mode: "visible", children: c });
    ...
    function ui(a, b, c, d, e) {
      ...
      0 === (f & 1) && b.child !== a
        ? ((c = b.child),
          ...
          (c.pendingProps = h),
          (b.deletions = null))
        : ((c = eb(a, h)), (c.subtreeFlags = a.subtreeFlags & 14680064));
        ...
        case 13:
          ...
          if (null !== d) {
            if (null !== d.dehydrated)
              return y(E, E.current & 1), (b.flags |= 128), null;
    ...
    function zk(a, b) {
      ...
      Gf = { focusedElem: a, selectionRange: c };
      Wc = !1;
      for (m = b; null !== m; )
        if (
          ((b = m), (a = b.child), 0 !== (b.subtreeFlags & 1028) && null !== a)
        )
          (a.return = b), (m = a);
        else
          for (; null !== m; ) {
                  ...
                  case 1:
                    if (null !== v) {
                      var x = v.memoizedProps,
                        z = v.memoizedState,
                        A = b.stateNode,
                        w = A.getSnapshotBeforeUpdate(
                          b.elementType === b.type ? x : wa(b.type, x),
                          z
                        );
    ...
    function If(a, b, c) {
      ...
      if (5 === d || 6 === d)
        ...
        for (If(a, b, c), a = a.sibling; null !== a; )
          If(a, b, c), (a = a.sibling);
    }
    function Jf(a, b, c) {
      var d = a.tag;
      if (5 === d || 6 === d)
        ...
        for (Jf(a, b, c), a = a.sibling; null !== a; )
          Jf(a, b, c), (a = a.sibling);
    }
    function hb(a, b, c) {
    ...
    function Ci(a, b, c) {
      ...
      switch (c.tag) {
        ...
        case 22:
          c.mode & 1
            ? ((U = (d = U) || null !== c.memoizedState), hb(a, b, c), (U = d))
            : hb(a, b, c);
          break;
        default:
          hb(a, b, c);
    ...
    function za(a, b, c) {
      ...
      if (b.subtreeFlags & 12854)
        for (b = b.child; null !== b; ) Ei(b, a), (b = b.sibling);
    }
    function Ei(a, b, c) {
      var d = a.alternate;
      c = a.flags;
                ...
                switch (h) {
                  ...
                  case "select":
                    ...
                    null != u
                      ...
                      : q !== !!f.multiple &&
                        (null != f.defaultValue
                          ? Ab(e, !!f.multiple, f.defaultValue, !0)
                          : Ab(e, !!f.multiple, f.multiple ? [] : "", !1));
                }
                e[qc] = f;
              } catch (v) {
                F(a, a.return, v);
    ...
    function sa(a, b, c) {
      ...
      ec(d, b, c);
      if (0 === (p & 2) || d !== G)
        d === G && (0 === (p & 2) && (Kd |= b), 4 === K && ib(d, R)),
          ha(d, c),
          1 === b && 0 === p && 0 === (a.mode & 1) && (Ec(), jd && bb());
      return d;
    }
    function Jd(a, b) {
      a.lanes |= b;
    ...
    function ha(a, b) {
      ...
      var d = Sc(a, a === G ? R : 0);
      if (0 === d)
        null !== c && Ji(c), (a.callbackNode = null), (a.callbackPriority = 0);
      else if (((b = d & -d), a.callbackPriority !== b)) {
        null != c && Ji(c);
        if (1 === b)
          0 === a.tag ? ik(Ki.bind(null, a)) : sh(Ki.bind(null, a)),
            Gk(function () {
              0 === p && bb();
            }),
            (c = null);
      ...
      if (0 !== b) {
        ...
        if (6 === b) ib(a, d);
          ...
          if (
            ...
            !Ik(e) &&
            ((b = Ld(a, d)),
            2 === b && ((f = te(a)), 0 !== f && ((d = f), (b = Mf(a, f)))),
            1 === b)
          )
            throw ((c = Gc), ub(a, 0), ib(a, d), ha(a, M()), c);
          a.finishedWork = e;
          a.finishedLanes = d;
          switch (b) {
            case 0:
    ...
    function ub(a, b) {
      ...
      if (null !== ma) {
        for (b = 0; b < ma.length; b++)
          if (((c = ma[b]), (d = c.interleaved), null !== d)) {
            c.interleaved = null;
            var e = d.next,
              f = c.pending;
            if (null !== f) {
          ...
          a: {
            ...
            if (
              ...
              if (0 === (m.mode & 1) && (0 === p || 11 === p || 15 === p)) {
                var q = m.alternate;
                q
                  ? ((m.updateQueue = q.updateQueue),
                    (m.memoizedState = q.memoizedState),
                    (m.lanes = q.lanes))
      ...
      if (null !== jb) {
        ...
        try {
          ...
          if (null === jb) var d = !1;
            ...
            p = e;
            bb();
            if (Ba && "function" === typeof Ba.onPostCommitFiberRoot)
              try {
    ...
    function qk(a, b, c) {
      ...
      G === a &&
        (R & c) === c &&
        (4 === K || (3 === K && (R & 130023424) === R && 500 > M() - Kf)
          ? ub(a, 0)
          : (Of |= c));
      ha(a, b);
    }
    function Si(a, b) {
      0 === b &&
        (0 === (a.mode & 1)
          ? (b = 1)
          : ((b = Pd), (Pd <<= 1), 0 === (Pd & 130023424) && (Pd = 4194304)));
      var c = Y();
      a = Jd(a, b);
    ...
    function sd(a, b, c, d, e, f) {
      ...
      if ("function" === typeof a) zf(a) && (g = 1);
        ...
        a: switch (a) {
          ...
          case ce:
            return (
              (a = qa(12, c, b, e | 2)), (a.elementType = ce), (a.lanes = f), a
            );
          case ee:
            return (
              (a = qa(13, c, b, e)), (a.elementType = ee), (a.lanes = f), a
            );
          case fe:
            return (
              (a = qa(19, c, b, e)), (a.elementType = fe), (a.lanes = f), a
            );
          case Ti:
            return Cd(c, e, f, b);
          default:
    ...
    var Qa = kb.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,
    ...
    var jj = function (a, b, c, d, e, f, g, h, k) {
      ...
      Aa = kb.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.Scheduler,
      Fg = Aa.unstable_scheduleCallback,
      Gg = Aa.unstable_NormalPriority,
      th = Fg,
      Ji = Aa.unstable_cancelCallback,
      Mk = Aa.unstable_shouldYield,
      Pk = Aa.unstable_requestPaint,
      M = Aa.unstable_now,
      Cj = Aa.unstable_getCurrentPriorityLevel,
      Be = Aa.unstable_ImmediatePriority,
      Ig = Aa.unstable_UserBlockingPriority,
      Yc = Gg,
      Dj = Aa.unstable_LowPriority,
      Jg = Aa.unstable_IdlePriority,
      Rc = null,
      Ba = null,
      ta = Math.clz32 ? Math.clz32 : oj,
      pj = Math.log,
      qj = Math.LN2,
      Tc = 64,
      Pd = 4194304,
      ...
      Wd = D({}, Jc, {
        ...
        movementX: function (a) {
          ...
          a !== Kc &&
            (Kc && "mousemove" === a.type
              ? ((Xf = a.screenX - Kc.screenX), (Yf = a.screenY - Kc.screenY))
              : (Yf = Xf = 0),
            (Kc = a));
          return Xf;
        },
      ...
      eh = ja(Wd),
      Yk = D({}, Wd, { dataTransfer: 0 }),
      Vj = ja(Yk),
      Zk = D({}, Jc, { relatedTarget: 0 }),
      Oe = ja(Zk),
      $k = D({}, Ub, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
      Xj = ja($k),
      al = D({}, Ub, {
      ...
      el = D({}, Jc, {
        key: function (a) {
          ...
          return "keypress" === a.type
            ? ((a = $c(a)), 13 === a ? "Enter" : String.fromCharCode(a))
            : "keydown" === a.type || "keyup" === a.type
            ? dl[a.keyCode] || "Unidentified"
            : "";
        },
        code: 0,
        location: 0,
      ...
      Wj = ja(gl),
      hl = D({}, Ub, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
      Yj = ja(hl),
      il = D({}, Wd, {
        deltaX: function (a) {
          return "deltaX" in a
    ...
    var dk = Ha && "TextEvent" in window && !Lc,
      Qg = Ha && (!Ee || (Lc && 8 < Lc && 11 >= Lc)),
    ...
    Ha &&
      (lh =
        Kj("input") && (!document.documentMode || 9 < document.documentMode));
    var ua = "function" === typeof Object.is ? Object.is : Rj,
      ck = Ha && "documentMode" in document && 11 >= document.documentMode,
      Gb = null,
      Ie = null,
      nc = null,
      He = !1,
    ...
    Ha &&
      ...
      "AnimationEvent" in window ||
        (delete Hb.animationend.animation,
        delete Hb.animationiteration.animation,
        delete Hb.animationstart.animation),
      "TransitionEvent" in window || delete Hb.transitionend.transition);
    var fh = ed("animationend"),
      gh = ed("animationiteration"),
      hh = ed("animationstart"),
      ih = ed("transitionend"),
      bh = new Map(),
      Yi =
    ...
    lb("onBeforeInput", ["compositionend", "keypress", "textInput", "paste"]);
    lb(
      "onCompositionEnd",
    ...
    var Bc =
      ...
      Tj = new Set(
        "cancel close invalid load scroll toggle".split(" ").concat(Bc)
      ),
      fd = "_reactListening" + Math.random().toString(36).slice(2),
      fk = /\r\n?/g,
      gk = /\u0000|\uFFFD/g,
      Ff = null,
      Gf = null,
      Nf = "function" === typeof setTimeout ? setTimeout : void 0,
      Kk = "function" === typeof clearTimeout ? clearTimeout : void 0,
      ...
      Ca = "__reactFiber$" + Vb,
      qc = "__reactProps$" + Vb,
      Ia = "__reactContainer$" + Vb,
      Ke = "__reactEvents$" + Vb,
      Ak = "__reactListeners$" + Vb,
      Bk = "__reactHandles$" + Vb,
      Re = [],
      Jb = -1,
      ab = {},
      I = $a(ab),
      ...
      E = $a(0),
      kf = [],
      vd = Qa.ReactCurrentDispatcher,
      sf = Qa.ReactCurrentBatchConfig,
      tb = 0,
      z = null,
      J = null,
      L = null,
      ...
      jk = {
        ...
        useCallback: function (a, b) {
          Ea().memoizedState = [a, void 0 === b ? null : b];
          return a;
        },
        useContext: la,
        useEffect: Qh,
    ...
    var vk = Qa.ReactCurrentOwner,
      ea = !1,
      Dd = { dehydrated: null, treeContext: null, retryLane: 0 },
      Gd = !1,
      U = !1,
      Ck = "function" === typeof WeakSet ? WeakSet : Set,
      m = null,
      yi = !1,
      Q = null,
      ya = !1,
      Jk = Math.ceil,
      Md = Qa.ReactCurrentDispatcher,
      Qf = Qa.ReactCurrentOwner,
      ba = Qa.ReactCurrentBatchConfig,
      p = 0,
      G = null,
      H = null,
      R = 0,
      ...
      switch (b.tag) {
          ...
          a: {
            ...
            if (f.isDehydrated)
              if (
                ...
                for (
                  fa = Ja(b.stateNode.containerInfo.firstChild),
                    ka = b,
                    C = !0,
                    xa = null,
                    c = ji(b, null, d, c),
        ...
        case 5:
          return (
            ...
            (g = e.children),
            Pe(d, e) ? (g = null) : null !== f && Pe(d, f) && (b.flags |= 32),
            oi(a, b),
            aa(a, b, g, c),
            b.child
          );
        ...
        case 4:
          return (
            gf(b, b.stateNode.containerInfo),
            (d = b.pendingProps),
            null === a ? (b.child = Rb(b, null, d, c)) : aa(a, b, d, c),
            b.child
          );
        case 11:
          return (
    ...
    var ll = { usingClientEntryPoint: !1, Events: [ac, Fb, Oc, qg, rg, Pf] };
    (function (a) {
      a = {
