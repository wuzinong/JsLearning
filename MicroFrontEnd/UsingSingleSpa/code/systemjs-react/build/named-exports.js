(function () {
  ...
  (function (global) {
    ...
    systemJSPrototype.getRegister = function () {
      ...
      if (
        !register ||
        register[1] === lastRegisterDeclare ||
        register[1].length === 0
      )
        return register;
      ...
      register[1] = function (_export, _context) {
        ...
        var declaration = registerDeclare.call(
          this,
          function (name, value) {
            if (typeof name === "object" && name && name.__useDefault)
              (defaultExport = name.default), (hasDefaultExport = true);
            else if (name === "default") defaultExport = value;
            else if (name === "__useDefault") hasDefaultExport = true;
            _export(name, value);
          },
          _context
        );
              ...
              for (var exportName in defaultExport) {
                if (
                  Object.prototype.hasOwnProperty.call(
                    defaultExport,
                    exportName
                  ) && // Check if epoxrt name is not inherited, safe for Object.create(null)
