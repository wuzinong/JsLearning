!(function (t, e) {
  ...
  "use strict";
  var C = "default" in c ? c.default : c;
  function r(t, e) {
          ...
          ? "/" !== o.pathname.charAt(0) &&
            (o.pathname = (function (t, e) {
              var n = 1 < arguments.length && void 0 !== e ? e : "",
                ...
                c = i || a;
              if (
                (t && d(t) ? (o = r) : r.length && (o.pop(), (o = o.concat(r))),
                !o.length)
              )
                return "/";
              var u = void 0;
  ...
  function w(t) {
    ...
    function E(t) {
      1 === (C += t) && 1 === t
        ? (window.addEventListener(N, y), e && window.addEventListener(H, m))
        : 0 === C &&
          (window.removeEventListener(N, y),
          e && window.removeEventListener(H, m));
    }
    var S = !1;
    var R = {
      length: c.length,
  ...
  var R = "hashchange",
    B = {
      ...
      noslash: { encodePath: g, decodePath: A },
  ...
  var z =
      ...
      function (r, o) {
        ...
        n.childContextTypes = (((t = {})[i] = h.object.isRequired), t);
        var a = (function (t) {
          function e() {
            var n;
            return (
  ...
  function tt(f) {
    ...
    return function (t, e) {
      for (
        var n = "",
          r = t || {},
          o = (e || {}).pretty ? Z : encodeURIComponent,
          i = 0;
        i < f.length;
        i++
      ) {
  ...
  function ot(t, e, n) {
    ...
    var f = et(n.delimiter || "/"),
      l = i.slice(-f.length) === f;
    return (
      r || (i = (l ? i.slice(0, -f.length) : i) + "(?:" + f + "(?=$))?"),
      (i += o ? "$" : r && l ? "" : "(?=" + f + "|$)"),
      nt(new RegExp("^" + i, rt(n)), e)
    );
  }
  function it(t, e, n) {
    return (
      ...
      t instanceof RegExp
        ...
        ? (function (t, e, n) {
            for (var r = [], o = 0; o < t.length; o++)
              r.push(it(t[o], e, n).source);
            return nt(new RegExp("(?:" + r.join("|") + ")", rt(n)), e);
          })(t, e, n)
        : (function (t, e, n) {
            return ot(X(t, n), e, n);
          })(t, e, n)
  ...
  var ct = {
    ...
    ft = {};
  function lt(t) {
    return a.isMemo(t) ? st : ft[t.$$typeof] || ct;
  }
  ft[a.ForwardRef] = {
    $$typeof: !0,
    render: !0,
  ...
  var gt = function t(e, n, r) {
      ...
      var i = ht(n);
      dt && (i = i.concat(dt(n)));
      for (var a = lt(e), c = lt(n), u = 0; u < i.length; ++u) {
        var s = i[u];
        if (!(ut[s] || (r && r[s]) || (c && c[s]) || (a && a[s]))) {
          var f = vt(n, s);
          try {
            pt(e, s, f);
          } catch (t) {}
        ...
        return (
          ((t = o.call.apply(o, [this].concat(n)) || this).history = (function (
            ...
            var p = x(a, 0, r.length - 1),
              ...
              d = j;
            function v(t) {
              var e = x(y.index + t, 0, y.entries.length - 1),
                n = y.entries[e];
            ...
            var y = {
              ...
              replace: function (t, e) {
                ...
                s.confirmTransitionTo(r, n, o, function (t) {
                  t &&
                    ((y.entries[y.index] = r), f({ action: n, location: r }));
                });
              },
              go: v,
              goBack: function () {
  ...
  var Ft = (function (o) {
      function t() {
        for (var e, t = arguments.length, n = new Array(t), r = 0; r < t; r++)
          n[r] = arguments[r];
        return (
          ((e = o.call.apply(o, [this].concat(n)) || this).handlePush =
            function (t) {
    ...
    Nt = (function (t) {
      ...
      return (
        ...
        (e.prototype.render = function () {
          var t = this;
          return C.createElement(bt.Consumer, null, function (n) {
            n || k(!1);
            var r,
              o,
              i = t.props.location || n.location;
            return (
              C.Children.forEach(t.props.children, function (t) {
                if (null == o && C.isValidElement(t)) {
                  var e = (r = t).props.path || t.props.from;
                  o = e ? Mt(i.pathname, T({}, t.props, { path: e })) : n.match;
                }
              }),
              o ? C.cloneElement(r, { location: i, computedMatch: o }) : null
            );
          });
        }),
        e
  ...
  var Vt = (function (o) {
      function t() {
        for (var t, e = arguments.length, n = new Array(e), r = 0; r < e; r++)
          n[r] = arguments[r];
        return (
          ((t = o.call.apply(o, [this].concat(n)) || this).history = w(
            t.props
          )),
          t
        );
  ...
  var Jt = qt(function (t, e) {
      var n = t.innerRef,
        r = t.navigate,
        o = t.onClick,
        i = at(t, ["innerRef", "navigate", "onClick"]),
        a = i.target,
        c = T({}, i, {
          onClick: function (e) {
            try {
      ...
      return (c.ref = (Wt !== qt && e) || n), C.createElement("a", c);
    }),
    Gt = qt(function (t, i) {
      var e = t.component,
        a = void 0 === e ? Jt : e,
        ...
        u = t.to,
        s = t.innerRef,
        f = at(t, ["component", "replace", "to", "innerRef"]);
        ...
        var n = e.history,
          ...
          o = T({}, f, {
            ...
            navigate: function () {
              ...
              (c ? n.replace : n.push)(t);
            },
          });
        return (
          Wt !== qt ? (o.ref = i || s) : (o.innerRef = s), C.createElement(a, o)
        );
      });
    }),
    Yt = C.forwardRef;
  ...
  var Qt = Yt(function (t, f) {
    ...
    return C.createElement(bt.Consumer, null, function (t) {
      ...
      var e = m || t.location,
        ...
        o = r && r.replace(/([.+*?=^!:${}()[\]|/\\])/g, "\\$1"),
        i = o
          ? Mt(e.pathname, { path: o, exact: v, sensitive: g, strict: w })
          : null,
        a = !!(y ? y(i, e) : i),
        c = a
          ? (function () {
        ...
        u = a ? T({}, b, {}, h) : b,
        s = T(
          { "aria-current": (a && l) || null, className: c, style: u, to: n },
          O
        );
      return (
        Kt !== Yt ? (s.ref = f || P) : (s.innerRef = P), C.createElement(Gt, s)
      );
    });
  });
  (t.BrowserRouter = Vt),
    ...
    (t.withRouter = function (r) {
      function t(t) {
        ...
        return C.createElement(bt.Consumer, null, function (t) {
          return t || k(!1), C.createElement(r, T({}, n, t, { ref: e }));
        });
      }
      var e = "withRouter(" + (r.displayName || r.name) + ")";
      return (t.displayName = e), (t.WrappedComponent = r), gt(t, r);
    }),
