<template>
  <f7-page>
    ...
    <f7-list>
      <f7-list-item link="/login/" title="登陆"></f7-list-item>
      <f7-list-item link="/main/" title="我的工作台"></f7-list-item>
      <f7-list-item link="/publishWork/" title="发布工作"></f7-list-item>
      <f7-list-item link="/payment/" title="支付"></f7-list-item>
