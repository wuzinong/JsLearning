    ...
    return {
        ...
        start:function(){
            ...
            httpServer.listen(port,function(){
                console.log("[HttpServer][Start]","runing at http://localhost:"+port+"/");
        ...
        processRequest:function(request,response){
            ...
            if(path.extname(pathName) === ''){
                ...
                //if (pathName.charAt(pathName.length-1) != "/"){
                    ...
                    // console.log("entered")
                    // var redirect = "http://"+request.headers.host + '/index.html';
                ...
                response.writeHead(200, {"content-type":"text/html"});
                    ...
                    var stream = fs.createReadStream(indexPath,{flags:"r",encoding:null});
